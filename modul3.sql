...
-- Latihan Mandiri
-- Soal 1
SELECT 4%2 AS sisa_bagi, 4*2 AS hasil_bagi1, 4 DIV 2 AS hasil_bagi2;
-- Soal 2
SELECT 4*8 AS hasil_kali, (4*8)%7 AS hasil_bagi;
-- Soal 3
...
datediff(NOW(), "2022-07-23"), datediff("2022-07-23", NOW());
-- Soal 3
SELECT MONTH("2022-07-23"), datediff(now(), "2022-07-23"), datediff("2022-07-23", NOW());
-- Soal 4 
SELECT DAY("2022-07-23"), datediff(now(), "2022-07-23"), datediff("2022-07-23", NOW());
-- Soal 5
SELECT YEAR(NOW());
...
FROM penjualan WHERE nama_produk = 'Flashdisk DQLab 32 GB';
